...
import { Prohibit, Scales, Flag, Question, BookOpen } from '@phosphor-icons/react/dist/ssr';
    ...
    <div className="yb-container" style={{ paddingBlock: 'var(--space-12)' }}>
      ...
      <section className="yb-section" style={{ maxWidth: 760 }}>
        ...
        <div className="yb-grid yb-grid-1" style={{ gap: 'var(--space-3)' }}>
          <RelatedLink href="/gomoku-rules" label={lang === 'zh' ? '五子棋规则（自由规则）' : 'Gomoku rules (free ruleset)'} />
