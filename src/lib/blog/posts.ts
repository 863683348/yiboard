...
export function getPostSlugs(): string[] {
  ...
  {
    slug: "gomoku-mobile-browser",
    date: "2026-08-22",
    title: {
      en: "Play Gomoku on Your Phone Browser (No App Required)",
      zh: "用手机浏览器玩五子棋（无需下载应用）",
    },
    excerpt: {
      en: "You don't need to download an app to play Gomoku on your phone. YiBoard's browser version works on any modern smartphone — iOS or Android — with full touch support.",
      zh: "你不需要下载应用就能在手机上下五子棋。YiBoard 的浏览器版本适用于任何现代智能手机——iOS 或 Android——并提供完整的触控支持。",
    },
    body: [
      { type: "p", text: "Most mobile board games require you to download a dedicated app. YiBoard is different. Our Gomoku game runs directly in your mobile browser, which means no downloads, no updates, and no storage space taken up." },
      { type: "h2", text: "How to Play on Mobile" },
      { type: "p", text: "The process is simple: open your phone's browser, navigate to yiboardgame.com/play, and the game auto-detects your device. Tap stones to place them on the 15x15 grid." },
      { type: "h2", text: "Touch Controls" },
      { type: "ul", items: [
        "Single tap: Place a stone",
        "Long press: Undo last move",
        "Pinch: Zoom in or out of the board",
        "Two-finger drag: Scroll the board",
      ] },
      { type: "h2", text: "Mobile-Specific Features" },
      { type: "ul", items: [
        "Haptic feedback: Feel each move (if your device supports it)",
        "Auto-save: Your game saves automatically",
        "Portrait mode: Optimized for one-handed play",
        "No lag: Built with WebAssembly for smooth performance",
      ] },
      { type: "h2", text: "Tips for Mobile Play" },
      { type: "ul", items: [
        "Use landscape mode for a larger board view",
        "Keep your phone charged — browser games can drain battery",
        "Close other apps to reduce lag",
        "Use a stylus if you have one for precision",
      ] },
      { type: "h2", text: "FAQ" },
      { type: "faq", items: [
        { q: "Do I need to create an account?", a: "No. Play as guest or sign in to save progress." },
        { q: "Can I play against friends on different devices?", a: "Yes. Share a game link and both can join from any browser." },
        { q: "Is the mobile version as good as desktop?", a: "Core gameplay is identical. Some visual features are simplified for mobile." },
      ] },
      { type: "cta", text: "Play Gomoku on your phone now", href: "https://yiboardgame.com/play" },
    ],
  }
];
